      ...
      <div className="pt-16 max-w-7xl mx-auto px-6 py-14">
        <div ref={titleRef}>
          ...
          <form onSubmit={handleSearch} className="flex items-center border-b-2 border-ink pb-3 max-w-lg mb-10 px-2">
            <input
              ...
              className="flex-1 bg-transparent text-2xl font-display font-semibold text-ink outline-none placeholder-ink/20"
            />
            <button type="submit" className="ml-4 text-ink/50 hover:text-accent transition-colors">
        ...
        {results.length === 0 && query && (
          <div className="text-center py-24">
            ...
            <p className="text-xs text-muted mb-4">Try searching for: Chair, Sofa, Lamp, Decor...</p>
          </div>
        )}
